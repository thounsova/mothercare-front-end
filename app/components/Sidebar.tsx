...
export default function Sidebar({ role, collapsed, setCollapsed }: SidebarProps) {
  ...
  return (
    <>
      {!openMobile && (
        <button
          className="fixed top-16 left-6 z-30 md:hidden bg-blue-300 text-white p-2 rounded-b-md shadow"
      ...
      >
        <div className="flex flex-col justify-between h-full">
          <div>
            <div className="flex items-center gap-3 p-5 border-b border-gray-200">
              {/* Logo */}
              <div className="w-12 h-12 flex-shrink-0 relative rounded-full overflow-hidden border border-gray-300">
                <Image
          ...
          <div className="p-4 border-t border-gray-200">
            <button
              ...
              className="flex items-center gap-3 w-full px-4 py-2 rounded-lg text-white hover:bg-red-600 hover:text-white transition"
            >
              <LogOut size={20} />
              {!collapsed && "Log Out"}
            </button>
        ...
        <button
          ...
          className="hidden md:flex absolute -right-3 top-10 bg-blue-400 text-white border rounded-full shadow p-1"
        >
